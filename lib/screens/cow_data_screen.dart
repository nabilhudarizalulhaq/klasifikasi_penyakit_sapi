...
class _CowDataScreenState extends State<CowDataScreen> {
  ...
  Widget build(BuildContext context) => Scaffold(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    initialValue: _type,
                    decoration: const InputDecoration(labelText: 'Jenis Sapi'),
                    items: ['Sapi Perah', 'Sapi Potong', 'Sapi Lokal']
                        .map((e) => DropdownMenuItem(value: e, child: Text(e)))
                        .toList(),
          ...
          AppCard(
            child: Column(
              children: [
                ...
                const Text(
                  'Tambahkan data sapi untuk mempermudah pencatatan diagnosis.',
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.pets, color: AppColors.emerald),
                    ),
                    ...
                    IconButton(
                      onPressed: () => setState(
                        () => widget.cows.removeWhere((e) => e.id == cow.id),
                      ),
                      icon: const Icon(
    ...
    floatingActionButton: widget.cows.isNotEmpty
